    ...
    for layers, layer_sources in izip_longest(layers_by_df, data_sources["layers"]):
        ...
        for layer, layer_source in izip_longest(layers, layer_sources):
            try:
                ...
                # if layer.supports("dataSource"): print(u"Layer '{0}': Current datasource: '{1}'".format(layer.longName, layer.dataSource).encode("ascii", "ignore"))
                ...
                # if layer.supports("dataSource"): print(u"Layer '{0}': New datasource: '{1}'".format(layer.longName, layer.dataSource).encode("ascii", "ignore"))
...
def validate_map(map):
    ...
    if len(broken_layers) > 0:
        ...
        for layer in broken_layers:
            ...
            #Some sort of layer
            # if layer.supports("workspacePath"): print(u"  workspace: {0}".format(layer.workspacePath))
            # if layer.supports("dataSource"): print(u"  datasource: {0}".format(layer.dataSource))
